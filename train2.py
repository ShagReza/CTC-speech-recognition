...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch_len', type=int, default=0,
    ...
    parser.add_argument('--model_save', type=str,default="drive/MyDrive/CTCsh",
                        help='Path, where to save model.')
    parser.add_argument('--checkpoint', type=int, default=1,
                        help='No. of epochs before save during training.')
    parser.add_argument('--model_load', type=str, default="drive/MyDrive/CTCsh",
