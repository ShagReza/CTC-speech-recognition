...
def main(args):
    # Paths to .csv files
    '''
    path = "data_dir/sample_librivox-dev-clean-wav.csv"
    ...
    path_validation ="data_dir/farsdat_small/farsdat_small_ph_3.csv"
    path_test = "data_dir/farsdat_small/farsdat_small_ph_3.csv"
...
if __name__ == '__main__':
    ...
    # Training params:
    #shaghayegh: for small validation batch size should be smaller
    parser.add_argument('--batch_size', type=int, default=1,
                        help='Number of files in one batch.')
    parser.add_argument('--epoch_len', type=int, default=2,
    ...
    parser.add_argument('--model_save', type=str,default="D:\Shapar\ShaghayeghUni\AfterPropozal\Phase3-SpeechRecognition\CTC-tools\CTCsh",
